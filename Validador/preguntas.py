    ...
    while True:
            while True:
                    ...
                    if opcion == "S" or opcion == "s":
                        ...
                        continue
            while True:
                opcion = input("El día de hoy hay archivos de corresponsales para validar?\n (S/N): ")
                if opcion == "S" or opcion == "s":
                    ...
                    escribir("Perfecto, continuemos con la consolidación y validación de los archivos de OPS.")
                    break
                else:
                    escribir("Selecciona una opcion valida.")
                    continue
